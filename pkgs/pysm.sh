...
src=$(eval "@TOP_DIR@/tools/fetch_check.sh" https://files.pythonhosted.org/packages/0a/bd/8a3d2306f3ab1ce06f3bf22139875ad01e7c9671286baebd016cd9662fa7/pysm3-${version}.tar.gz  ${pfile})
